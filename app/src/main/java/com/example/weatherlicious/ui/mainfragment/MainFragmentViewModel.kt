...
class MainFragmentViewModel @Inject constructor(
    ...
    private var _localCurrentWeather = MutableLiveData<CurrentWeather>()
    ...
    fun transformNetworkForecastWeatherIntoLocalCurrentWeather(context: Context){
        viewModelScope.launch (Dispatchers.IO) {
            ...
            val localCurrentWeather = LocalCurrentWeather(0, cityName, timeStamp, icon ,condition, wind, maxAndMinTemp, feelsLike)
